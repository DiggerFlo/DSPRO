  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div style={{ fontSize: 14, fontWeight: 600, color: th.text, lineHeight: 1.4, marginBottom: 4, fontFamily: serif }}>
            {source.title}
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            <span style={{ fontSize: 12, color: th.textMuted, fontFamily: "Inter,sans-serif" }}>{source.date}</span>
          ...
          {open && (
            <p className="slide-down" style={{ marginTop: 10, fontSize: 13, color: th.textMid, lineHeight: 1.7, fontFamily: "Inter,sans-serif", borderLeft: `2px solid ${th.accent}`, paddingLeft: 10, marginLeft: 0 }}>
              {source.snippet}
            </p>
          )}
        </div>
